...
public class UI2DSprite : UIBasicSprite
{
	...
	#region Lee : Sprite Gray 관련 추가사항
	...
	public Material spriteMaterialGrayscale
	{
		get
		{
			...
			{
				materialGray = new Material(shader);
	...
	public Material spriteMaterialBright
	{
		get
		{
			...
			{
				materialBright = new Material(shader);
	...
	public override Material material
	{
		get
		{
			if (isGray) return spriteMaterialGrayscale;
			if (isBright) return spriteMaterialBright;
