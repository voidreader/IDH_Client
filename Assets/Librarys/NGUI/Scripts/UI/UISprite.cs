    ...
    public override Material material
    {
        get
        {
            if (mAtlas != null)
            {
                if (isGray)
                {
                    return ((UIAtlas)mAtlas).spriteMaterialGrayscale;
                }
                if (isBright)
                {
                    return ((UIAtlas)mAtlas).spriteMaterialBright;
                }
            }
            return (base.material != null ? base.material : (mAtlas != null ? ((UIAtlas)mAtlas).spriteMaterial : null));
        }
        set
        {
            base.material = value;
